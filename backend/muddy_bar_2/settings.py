"""
Django settings for muddy_bar_2 project.
...
WSGI_APPLICATION = 'muddy_bar_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_bar_2 API",
    "DESCRIPTION": "API documentation for muddy_bar_2 App",
    "VERSION": "v1",
}
